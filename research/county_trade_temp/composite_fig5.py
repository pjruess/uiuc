...
img_paths = ['figures/degree_dist.png','figures/degree_in_dist.png','figures/degree_out_dist.png','figures/strength_dist.png','figures/strength_in_dist.png','figures/strength_out_dist.png']
...
plt.savefig('figures/fig5_test.png',bbox_inches='tight',dpi=1800)
