...
# Read in data
df <- read.csv('results/2000_2010/input_data_clean_stage0.csv')
...
df2 <- read.csv('results/2000_2010/input_data_clean_stage_control.csv')
df2 <- na.omit(df2)

df.gwd <- read.csv('results/2000_2010/input_data_clean_stage_gwd.csv')
...
write.csv(df2,file='results/2000_2010/input_data_clean_stage1.csv',row.names = FALSE)
