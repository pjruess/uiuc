...
dist.path <- 'cleandata/1960_2010/dist_cepii.csv'
...
geo.path <- 'cleandata/1960_2010/geo_cepii.csv'
...
ck.path <- 'cleandata/1960_2010/pwt90.csv'
...
pop.path <- 'cleandata/1960_2010/population.csv'
...
to.path <- 'cleandata/1960_2010/trade_openness.csv'
if (!file.exists(to.path)) {
    print(glue('Creating file: {to.path}'))
    
    # Read in export data 
    exp.path <- 'cleandata/1960_2010/exports.csv'
    ...
    # Read in import data
    imp.path <- 'cleandata/1960_2010/imports.csv'
...
# Temperature data
temp.path <- 'cleandata/1960_2010/temperature.csv'
...
# Rainfall data
rf.path <- 'cleandata/1960_2010/rainfall.csv'
...
# Read in wto data
wto.path <- 'cleandata/1960_2010/wto.csv'
...
if (!file.exists(biopen.path)) {
    ...
    # write.csv(biopen,"cleandata/1960_2010/bi_trade.csv", row.names = F)
    # biopen <- read.csv("cleandata/1960_2010/bi_trade.csv")
} else {
...
### Stage 0 Dataframe
st0.path <- 'results/1960_2010/input_data_clean_stage0.csv'
...
### Stage 1 Dataframe
st1.path <- 'results/1960_2010/input_data_clean_stage_control.csv'
...
st2.path <- 'results/1960_2010/input_data_clean_stage_gwd.csv'
if (!file.exists(st2.path)) {
    ...
    gwd.path <- 'cleandata/1960_2010/gwd.csv'
