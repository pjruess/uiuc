...
# Read in data
df <- read.csv('results/1980_2010/input_data_clean_stage0.csv') # all input data (from clean_data.r script)
...
df2 <- read.csv('results/1980_2010/input_data_clean_stage_control.csv')
df2 <- na.omit(df2)

df.gwd <- read.csv('results/1980_2010/input_data_clean_stage_gwd.csv')
...
write.csv(df2,file='results/1980_2010/input_data_clean_stage1.csv',row.names = FALSE)
